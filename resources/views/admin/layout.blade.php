...
<head>
    <title>Bravo's - @yield('titulo')</title>
    <meta charset="utf-8">
        ...
        <div class="navbar-wrapper">
            <div class="navbar-brand header-logo">
                <a href="index.html" class="b-brand">
                    ...
                    <span class="b-title">Bravo's Admin</span>
                </a>
                ...
                <ul class="nav pcoded-inner-navbar">
                    ...
                    <li data-username="Vertical Horizontal Box Layout RTL fixed static collapse menu color icon dark" class="nav-item pcoded-hasmenu active pcoded-trigger">
                        ...
                        <ul class="pcoded-submenu">
                            ...
                            <li class="active"><a href="layout-dark.html" class="" target="_blank">Dark layout <span class="pcoded-badge label label-danger">Hot</span></a></li>
                ...
                <li>
                    <div class="dropdown drp-user">
                        ...
                        <div class="dropdown-menu dropdown-menu-right profile-notification">
                            ...
                            <ul class="pro-body">
                                <li><a href="#" class="dropdown-item"><i class="fas fa-address-book"></i> Mi perfil</a></li>                                
                                <li><a href="{{route('admin.logout')}}" class="dropdown-item"><i class="feather icon-log-out"></i> Cerrar sesión</a></li>
                            </ul>
                        </div>
                    </div>
                </li>
